...
router.post('/:id/accept/:applicationId', roleMiddleware(['provider']), acceptApplicant);
router.post('/:id/reject/:applicationId', roleMiddleware(['provider']), rejectApplicant);
router.delete('/:id', roleMiddleware(['provider']), deleteJob);

// Seeker routes
router.post('/:id/apply', roleMiddleware(['seeker']), applyJobValidation, applyForJob);
